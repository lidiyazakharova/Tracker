...
//        let num = viewModel.countCategories()
//        print(num)
//        return num
    }
...
////MARK: - NewCategoryViewControllerDelegate
//extension CategoryViewController: NewCategoryViewController {
//    func addNewCategories(category: String) {
//        if !viewModel.trackerCategories.contains(where: { $0.title == category }) {
